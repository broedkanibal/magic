...
**Efter** avstämningens ändringar 2026-09-23 ("ett spår som kommer tillbaka på en ny plats bär inte längre sitt kort" och "högvakten: ändringen måste komma efter att kortet försvann"; flyttar via nedtoning avfärdat), jämfört med [före](2026-09-22-1x-34cm-normaltempo-ai.md): på mattan syntes 35/59 → 35/59 och rätt kort 33/59 → 34/59 — tar_bort rätt kort 4/6 → 5/6, rätt plats 3/5 → 4/5, längst +7,92 → +3,00 s. Rad 34 och 44 går nu till graveyard, rad 51 har inget fel kort längre, rad 23 blir frågan i stället för graveyard.
...
| tar_bort | 6 | 5/6 | 5/6 | – | 4/5 | – | +2,58 s | +3,00 s |
...
| **på mattan** | 59 | 35/59 | 34/59 | | | | +2,77 s | |
...
| 34 | 152,28 | tar_bort | Pharika's Chosen | ja | +2,22 s | nedtonat, sedan till graveyard +2,67 s (högvakten) — högvakten: ändring +2,67 s |
