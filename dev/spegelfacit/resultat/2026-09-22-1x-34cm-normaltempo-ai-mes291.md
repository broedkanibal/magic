...
**Efter MES-291** (ett tappat kort väntar 5 s innan det tonas ned, och graveyard-högen som växer avbryter väntan), jämfört med main före (22644e3, samma tal som [efter 2026-09-23](2026-09-22-1x-34cm-normaltempo-ai-efter.md)): på mattan 35/59 → 35/59, rätt kort 34 → 34. **Flyttar via nedtoning 4 → 0**: rad 29, 35, 59 och 61 är nu samma kort som flyttar, utan nedtoning emellan (flytten syns lika sent som förut, när namnet kommer). Rad 18 och 34 går till graveyard direkt när högen växer (+3,10 och +2,67 s, samma tid som förut) i stället för att först tonas ned. Nedtoningar i hela passet 17 → 10, varav utan facitrad 10 → 5; nedtonade kort på bordet i medel 1,21 → 1,04 (varje sekund, `antal.cjs --steg 1`), som mest 6 → 4. `diff_kort` oförändrat (median −1). **Sämre:** rad 66 tonas ned +1,89 → +6,29 s (högens ändring +4,34 s gick inte att ge Pharika's Chosen, ett Swamp försvann samtidigt), och kort som fästs vid ett annat (rad 23, 36, 60) tonas ned ~4,4 s senare.


Källa: `dev/material/inspelningar/2026-09-22-1x-34cm-normaltempo/spegel-ai.json` (körd 2026-09-23 10:00). Med Claude (claude-opus-5, systemprompt v20, 2 namn via Claude). Poolen: 114 kort. 1081 bord från telefonen, uppspelade genom datorns avstamBord med grundläget 90°, lekens antal ur lek.txt, nåd 5000 ms. Fönster: 2 s före till 10 s efter facits tid.
...
| tar_bort | 6 | 5/6 | 5/6 | – | 4/5 | – | +2,95 s | +6,29 s |
...
| **på mattan** | 59 | 35/59 | 34/59 | | | | +2,86 s | |
...
| 30 | 137,88 | flyttar | Valkyrie's Sword | under, till Pharika's Chosen | ingen flytt (under 15 % av kortbredden, eller inte sedd) | syntes inte |
...
| 36 | 162,88 | flyttar | Valkyrie's Sword | ovanpå, till Trusty Retriever | nedtonat +5,57 s, inget kort på nya platsen | syntes inte |
...
| 41 | 183,42 | grav_ur_bild | Pharika's Chosen | – | graveyard: Pharika's Chosen 1 → 1 — högvakten: ändring +2,88 s | syntes inte |
...
| 45 | 203,40 | otappar | Swamp | översta i hög A | ingen vridning (2 Swamp på bordet, 1 tappade) | syntes inte |
...
| 51 | 225,22 | tar_bort | Killing Glare | till grav | fanns inte på bordet — högvakten: ändring +2,93 s | syntes inte |
...
| 59 | 250,46 | flyttar | Mirran Bardiche | ovanpå, till Scourge of the Undercity | flytt, samma kort (0.4 kortbredder) (+6,79 s) — ligger ensamt | fel plats |
...
| 61 | 254,40 | flyttar | Mirran Bardiche | ovanpå, till Scourge of the Undercity | flytt, samma kort (0.36 kortbredder) (+3,15 s) — ligger ensamt | fel plats |
...
| 66 | 267,76 | tar_bort | Pharika's Chosen | till grav | nedtonat (+6,29 s) — högvakten: ändring +4,34 s | fel plats |
...
| 29 | 131,52 | flyttar | Valkyrie's Sword | ja | +7,53 s | flytt, samma kort (2.75 kortbredder) — ligger ihop med Pharika's Chosen |
| 30 | 137,88 | flyttar | Valkyrie's Sword | nej | – | ingen flytt (under 15 % av kortbredden, eller inte sedd) |
...
| 34 | 152,28 | tar_bort | Pharika's Chosen | ja | +2,67 s | till graveyard (högvakten) — högvakten: ändring +2,67 s |
| 35 | 157,58 | flyttar | Valkyrie's Sword | ja | +3,52 s | flytt, samma kort (4.27 kortbredder) — ligger ensamt |
| 36 | 162,88 | flyttar | Valkyrie's Sword | nej | – | nedtonat +5,57 s, inget kort på nya platsen |
...
| 41 | 183,42 | grav_ur_bild | Pharika's Chosen | nej | – | graveyard: Pharika's Chosen 1 → 1 — högvakten: ändring +2,88 s |
...
| 44 | 200,22 | tar_bort | Ukud Cobra | ja | +2,58 s | nedtonat, sedan till graveyard +3,78 s (högvakten) — högvakten: ändring +3,78 s |
| 45 | 203,40 | otappar | Swamp | nej | – | ingen vridning (2 Swamp på bordet, 1 tappade) |
...
| 49 | 217,24 | spelar | Pharika's Chosen | ja | +2,96 s | ut ur graveyard |
| 50 | 221,48 | tappar | Pharika's Chosen | ja | +2,02 s | tappat — ligger ensamt |
| 51 | 225,22 | tar_bort | Killing Glare | nej | – | fanns inte på bordet — högvakten: ändring +2,93 s |
...
| 59 | 250,46 | flyttar | Mirran Bardiche | ja | +6,79 s | flytt, samma kort (0.4 kortbredder) — ligger ensamt |
| 60 | 254,40 | flyttar | Scourge of the Undercity | nej | – | nedtonat +2,10 s, inget kort på nya platsen |
| 61 | 254,40 | flyttar | Mirran Bardiche | ja | +3,15 s | flytt, samma kort (0.36 kortbredder) — ligger ensamt |
...
| 66 | 267,76 | tar_bort | Pharika's Chosen | ja | +6,29 s | nedtonat — högvakten: ändring +4,34 s |
...
- **flyttat** (28): 39,5 s Killing Glare 0.18 kb · 67,7 s Swamp 0.39 kb · 76,0 s Swamp 0.18 kb · 108,0 s Swamp 0.21 kb · 134,1 s Swamp 0.21 kb · 142,3 s Swamp 0.16 kb · 146,1 s Swamp 0.31 kb · 153,0 s Pharika's Chosen 0.32 kb · 153,6 s Pharika's Chosen 0.32 kb · 165,2 s Swamp 0.33 kb · 172,7 s Swamp 0.6 kb · 197,3 s Ukud Cobra 0.36 kb · 197,6 s Ukud Cobra 0.29 kb · 202,8 s Ukud Cobra 1.37 kb · 202,8 s Mirran Bardiche 2.37 kb · 217,8 s Trusty Retriever 0.18 kb · 220,2 s Pharika's Chosen 4.42 kb · 221,7 s Swamp 0.2 kb · 226,1 s Mirran Bardiche 0.25 kb · 226,3 s Mirran Bardiche 0.38 kb · 236,4 s Swamp 2.98 kb · 240,8 s Mirran Bardiche 0.22 kb · 246,3 s Swamp 0.22 kb · 252,0 s Swamp 0.16 kb · 274,4 s Mirran Bardiche 0.21 kb · 278,3 s Valkyrie's Sword 1.17 kb · 278,4 s Scourge of the Undercity 0.7 kb · 288,0 s Scourge of the Undercity 1.06 kb
...
- **nedtonat** (5): 216,0 s Swamp · 273,8 s Swamp · 279,8 s Trusty Retriever · 281,3 s Mirran Bardiche · 291,0 s Swamp
