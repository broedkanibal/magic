...
**Efter** avstämningens ändringar 2026-09-23 (samma som i [AI-rapporten](2026-09-22-1x-34cm-normaltempo-ai-efter.md)), jämfört med [före](2026-09-22-1x-34cm-normaltempo-lokal.md): på mattan 20/59 → 20/59, inga räknade rader ändrade. Ukuds spöksspår tar inte längre Trusty Retrievers plats (rad 54 "ihop med Ukud" → "ensamt"), och Ukud slutar i graveyard i stället för nedtonad.

Källa: `dev/material/inspelningar/2026-09-22-1x-34cm-normaltempo/spegel-lokal.json` (körd 2026-09-23 09:55). Utan Claude — bara telefonens egen igenkänning. Poolen: 114 kort. 1012 bord från telefonen, uppspelade genom datorns avstamBord med grundläget 90°, lekens antal ur lek.txt, nåd 600 ms. Fönster: 2 s före till 10 s efter facits tid.

## Per händelsetyp

| Händelse | Rader | Syntes | Rätt kort | Rätt tap-läge | Rätt plats | Fäst digitalt | Median efter facit | Längst |
|---|---|---|---|---|---|---|---|---|
| spelar | 13 | 9/13 | 9/13 | 9/9 | 6/7 | – | +2,01 s | +2,81 s |
| grav_till_bord | 1 | 1/1 | 1/1 | 1/1 | 0/1 | – | +3,16 s | +3,16 s |
| tar_bort | 6 | 5/6 | 5/6 | – | 4/5 | – | +2,95 s | +7,92 s |
| tappar | 13 | 2/13 | 2/13 | 2/2 | 2/2 | – | +2,79 s | +3,56 s |
| otappar | 8 | 1/8 | 1/8 | 1/1 | 1/1 | – | -1,95 s | -1,95 s |
| flyttar | 18 | 2/18 | 2/18 | 2/2 | 1/1 | – | +3,24 s | +3,71 s |
| drar | 6 | 0/6 | 0/6 | – | – | – | – | – |
| grav_ur_bild | 2 | 0/2 | 0/2 | – | – | – | – | – |
| **på mattan** | 59 | 20/59 | 20/59 | | | | +2,28 s | |
...
| 23 | 113,62 | flyttar | Mirran Bardiche | ovanpå, till Ukud Cobra | nedtonat +2,78 s, inget kort på nya platsen | syntes inte |
...
| 46 | 207,02 | flyttar | Swamp | hög A | nedtonat +4,48 s, inget kort på nya platsen | syntes inte |
...
| 59 | 250,46 | flyttar | Mirran Bardiche | ovanpå, till Scourge of the Undercity | nedtonat +4,54 s, inget kort på nya platsen | syntes inte |
| 60 | 254,40 | flyttar | Scourge of the Undercity | tillsammans med mirran bardiche som är fäst | kortet fanns inte på bordet | syntes inte |
...
| 18 | 95,30 | tar_bort | Flutterfox | ja | +2,95 s | nedtonat, sedan till graveyard +3,10 s (högvakten) — högvakten: ändring +3,10 s |
...
| 23 | 113,62 | flyttar | Mirran Bardiche | nej | – | nedtonat +2,78 s, inget kort på nya platsen |
...
| 46 | 207,02 | flyttar | Swamp | nej | – | nedtonat +4,48 s, inget kort på nya platsen |
...
| 51 | 225,22 | tar_bort | Killing Glare | ja | +2,48 s | nedtonat, sedan till graveyard +4,43 s (högvakten) — högvakten: ändring +2,93 s |
...
| 59 | 250,46 | flyttar | Mirran Bardiche | nej | – | nedtonat +4,54 s, inget kort på nya platsen |
| 60 | 254,40 | flyttar | Scourge of the Undercity | nej | – | kortet fanns inte på bordet |
...
| 65 | 263,34 | spelar | Ancestral Blade | ja | +2,01 s | ny |
| 66 | 267,76 | tar_bort | Pharika's Chosen | ja | +1,79 s | nedtonat, sedan till graveyard +4,34 s (högvakten) — högvakten: ändring +4,34 s |
...
- **flyttat** (16): 39,5 s Killing Glare 0.18 kb · 110,7 s Ukud Cobra 0.18 kb · 110,8 s Ukud Cobra 0.17 kb · 139,1 s Ukud Cobra 0.27 kb · 148,7 s Pharika's Chosen 0.3 kb · 175,1 s Swamp 0.8 kb · 175,8 s Swamp 0.58 kb · 197,1 s Killing Glare 1.83 kb · 215,3 s Killing Glare 0.18 kb · 215,4 s Killing Glare 0.23 kb · 217,8 s Trusty Retriever 0.18 kb · 219,3 s Ukud Cobra 1.07 kb · 219,4 s Ukud Cobra 0.99 kb · 220,1 s Pharika's Chosen 4.31 kb · 267,3 s Ancestral Blade 0.48 kb · 273,4 s Mirran Bardiche 1.07 kb
- **ny** (2): 54,3 s Swamp · 101,5 s Swamp
- **fråga** (14): 96,3 s Swamp · 138,9 s Night's Whisper · 139,3 s Plains · 161,1 s Valkyrie's Sword · 170,4 s Swamp · 171,8 s Ukud Cobra · 173,6 s Swamp · 219,8 s Plains · 220,2 s Night's Whisper · 226,2 s Ukud Cobra · 270,4 s Plains · 273,8 s Mirran Bardiche · 275,6 s Thriving Heath · 278,3 s Trusty Retriever
- **tappat** (3): 101,8 s Swamp · 102,2 s Swamp · 267,6 s Ancestral Blade
- **otappat** (1): 134,8 s Swamp
- **nedtonat** (9): 135,0 s Mirran Bardiche · 174,6 s Swamp · 211,5 s Swamp · 219,0 s Swamp · 219,2 s Trusty Retriever · 222,9 s Pharika's Chosen · 226,1 s Ukud Cobra · 252,2 s Scourge of the Undercity · 277,2 s Mirran Bardiche
- **till graveyard** (1): 229,7 s Ukud Cobra
